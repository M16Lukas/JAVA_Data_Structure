...
public class Polynomial2 {
  ...
  private Term2[] terms = new Term2[100]; // 다항식을 구성하는 항들을 저장할 배열

  // Constructor
  public Polynomial2(char name, int nTerms) {
    this.name = name;
    this.nTerms = nTerms;
  }
  ...
  public void setTerms(Term2[] terms) {
    this.terms = terms;
  }

  public Term2[] getTerms() {
    return terms;
  }
